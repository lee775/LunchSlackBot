...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}KakaoTalk-Slack Bot - 테스트${NC}"
echo -e "${BLUE}Test Channel: C09CKLSJDJ6${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
export SLACK_CHANNEL_ID=C09CKLSJDJ6
export SLACK_STARTUP_CHANNEL_ID=C09CKLSJDJ6
export SLACK_LUNCH_CHANNEL_ID=C09CKLSJDJ6

echo -e "${YELLOW}[INFO]${NC} Environment: development"
echo -e "${YELLOW}[INFO]${NC} Log Level: debug"
echo -e "${YELLOW}[INFO]${NC} Test Channel: C09CKLSJDJ6"
echo ""
